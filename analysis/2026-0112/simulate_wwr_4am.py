"""
Simulate bot trading for WWR from 4 AM today with full day data including after-hours
Downloads full day data, saves to test_data, and runs bot simulation
"""
import sys
import os
...
def main():
    ...
    logger.info(f"\n{'='*80}")
    logger.info(f"Simulating {TICKER} from 4 AM ({today}) - Full Day Including After-Hours")
    logger.info(f"{'='*80}")
